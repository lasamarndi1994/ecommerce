<div>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create a product</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form wire:submit.prevent="productCreate()">
                <!-- Form Group (username)-->
                <div class="mb-3">
                ...
                <div class="row gx-3 mb-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input class="form-control" id="name" type="text" wire:model.lazy="name" placeholder="Enter your product name"
                         >
                        @error('name')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                ...
                <div class="row gx-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="qty" min="0" type="number"
                        wire:model.lazy="qty"
